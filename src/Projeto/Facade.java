...
public class Facade {
	 ...
	 * @param telefone
	 * @param atributo
	 * @return um atributo do usuario de acordo com o atributo passado como parametro
	 */
	...
	/**
	 * Atualiza um atributo do usuario de acordo com o atributo passado como parametro e o valor para modificar
	 * 
	...
	/**
	 * Cadastra um Jogo Eletronico passando o nome, telefone, nome do item, preco e plataforma como parametro
	 * 
	 * @param nome
	 * @param telefone
	 * @param nomeItem
	...
	/**
	 * Cadastra um Jogo de Tabuleiro passando o nome, telefone, nome do item e preco 
	 * 
	 * @param nome
	 * @param telefone
	 * @param nomeItem
	...
	/**
	 * Cadastra um Bluray Filme passando o nome, telefone, nome do item, preco, duracao, genero, classificacao e ano de lancamento
	 * 
	 * @param nome
	 * @param telefone
	 * @param nomeItem
	...
	/**
	 * Cadastra um Bluray Show passando o nome, telefone, nome do item, preco, duracao, numero de faixas, artista e classificacao
	 * 
	 * @param nome
	 * @param telefone
	 * @param nomeItem
	...
	/**
	 * Cadastra um Bluray Serie passando o nome, telefone, nome do item, preco, descricao, duracao, classificacao, genero e temporada
	 * 
	 * @param nome
	 * @param telefone
	 * @param nomeItem
	...
	/**
	 * adiciona um bluray a lista de episodio de bluray serie
	 * passando como parametro nome, telefone, nome do bluray temporada e duracao
	 * 
	 * @param nome
	 * @param telefone
	 ...
	 * @param nomeItem
	 * @param atributo
	 * @return um atributo do item de acordo com o atributo passado como parametro
	 */
	...
	/**
	 * Atualiza um atributo do item de acordo com o atributo passado como parametro e o valor para modificar
	 * 
	...
	/**
	 * Representacao em forma de string de uma lista que está ordenada alfabeticamente 
	 * 
	...
	/**
	 * Representacao em forma de string de uma lista que está ordenada pelo valor 
	 * 
	 ...
	 * @param telefone
	 * @param nomeItem
	 * @return a representacao de um item, passados usuario(nome e telefone) e nome do item como parametro
	 */
	...
	/**
	 * Registra um emprestimo apartir de um usuario(Dono) para um usuario(Requerente, passando um item, data de emprestimo e o periodo como parametros
	 * 
	 * @param nomeDono
	 * @param telefoneDono
	...
	/**
	 * Devolve um item emprestado apartir de um usuario(Dono) para um usuario(Requerente, passando um item, data de emprestimo e o periodo como parametros
	 * 
	 * @param nomeDono
	 * @param telefoneDono
	 * @param nomeRequerente
	...
	/**
	 * Representacao em forma de string de uma lista de usuarios com itens emprestados 
	 * 
	 * @param nome
	 * @param telefone
	...
	/**
	 * Representacao em forma de string de uma lista de usuarios com itens que pegou emprestado
	 * 
	 * @param nome
	 * @param telefone
	...
	/**
	 * 
	 * @return um representacao em lista dos caloteiros, usuarios com reputacao negativa
	 */
